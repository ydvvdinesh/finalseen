                ...
                >
                  <div className="text-left">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="text-2xl font-black text-white">4000+</div>
                    </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 max-w-6xl mx-auto">
              ...
              >
                <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-pink-500/30 transition-all duration-500 hover:transform hover:scale-[1.02] sm:hover:scale-105 relative overflow-hidden h-full">
                  <div className="absolute inset-0 bg-gradient-to-br from-pink-400/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-pink-400 font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Host & Content Creator</p>
                    <p className="text-gray-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              ...
              <motion.div
                ...
                className="group text-center"
              >
                <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-yellow-500/30 transition-all duration-500 hover:transform hover:scale-[1.02] sm:hover:scale-105 relative overflow-hidden h-full">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                      Edits event recordings, creates highlight reels and tutorial videos to power our YouTube and social channels.
                    </p>
