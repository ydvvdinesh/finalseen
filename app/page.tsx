...
export default function HomePage() {
  ...
  return [
    ...
    <div className="min-h-screen bg-black relative overflow-hidden" id="home" key="main-content">
      ...
      {/* About Section */}
      <section id="about" className="py-0 relative mt-20 sm:mt-28 md:mt-36">
              ...
              >
                <div className="text-left">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-2xl font-black text-white">2100+</div>
                  </div>
      ...
      <section id="team" className="py-4 sm:py-6 md:py-8 relative mt-20 sm:mt-28 md:mt-36">
        <motion.div
        ...
        >
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed px-2">
                The passionate individuals driving CodeNeuraX forward and building an amazing community.
              </p>
            </motion.div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 max-w-6xl mx-auto">
              ...
              >
                <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-purple-500/30 transition-all duration-500 hover:transform hover:scale-[1.02] sm:hover:scale-105 relative overflow-hidden h-full">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-purple-400 font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Content Manager</p>
                    <p className="text-gray-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                      Creative content strategist focused on delivering engaging educational materials and
              ...
              >
                <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 hover:border-pink-500/30 transition-all duration-500 hover:transform hover:scale-[1.02] sm:hover:scale-105 relative overflow-hidden h-full">
                  ...
                  <div className="relative z-10">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-4 rounded-full bg-gradient-to-r from-pink-400 to-rose-500 flex items-center justify-center text-white text-2xl sm:text-3xl font-bold">
                      TBA
                    </div>
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2 group-hover:text-pink-400 transition-colors">
                      TBA
                    </h3>
                    <p className="text-pink-400 font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Outreach Manager</p>
                    <p className="text-gray-300 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                      Dedicated to building meaningful connections and expanding our community reach through strategic
