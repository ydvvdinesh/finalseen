        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl">
              Join CodeNeuraX as a Campus Ambassador. Organize events, grow communities, and unlock exclusive perks.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                <div className="flex flex-col gap-5 items-center">
                  {a.avatar ? (
                    <div className="relative h-28 w-28 rounded-full overflow-hidden">
                      <Image src={a.avatar} alt={a.name} fill sizes="112px" className="object-cover" />
                    </div>
                  ) : (
                  ...
                  <div className="w-full">
                    ...
                    {a.department && (
                      <div className="flex items-center gap-2 text-gray-400 text-sm mt-2">
                        ...
                        <span>{a.department}{a.year ? ` • ${a.year}` : ""}</span>
                      </div>
                    )}
                    {(a.email || a.socials?.length) && (
                      <div className="mt-4">
                        <div className="text-gray-400 text-xs mb-2">Contact information</div>
                        <div className="flex flex-wrap gap-3">
                          ...
                          {a.socials?.find(s => s.platform.toLowerCase() === "linkedin") && (
                            <a
                              href={a.socials!.find(s => s.platform.toLowerCase() === "linkedin")!.url}
                              target="_blank"
                              rel="noopener noreferrer"
